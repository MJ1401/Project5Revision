...
public class DrawingForest20 extends RandomForest<Drawing,String,DrawingPoint, PixelUse> implements PixelUser {
    private int width, height;

    public DrawingForest20() {
        super(20, Drawing::allFeatures, Drawing::getFeatureValue, PixelUse::successor);
    }
